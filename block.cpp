...
void CreateObb(int nCnt)
{
	...
	g_Block[nCnt].Obb.Length[0] = fabsf(Length[0]) * 0.55f; // 長さX
	g_Block[nCnt].Obb.Length[1] = fabsf(Length[1]) * 0.55f; // 長さY
	g_Block[nCnt].Obb.Length[2] = fabsf(Length[2]) * 0.55f; // 長さZ
