...
void colisionSword(int nCntBoss)
{
	...
	{
		HitBoss(nCntBoss, (pPlayer->nDamage * 22) / fCutDamage); // 敵に当たった
	}
	// 両手持ちの必殺技
	...
	{
		HitBoss(nCntBoss, (pPlayer->nDamage * 8) / fCutDamage); // 敵に当たった
	}
	// 片手の必殺技
	...
	{
		HitBoss(nCntBoss, (pPlayer->nDamage * 24) / fCutDamage); // 敵に当たった
	}
