...
void UpdateKickAttack(int nCntEnemy);																		 // 敵の蹴り攻撃の更新処理
void UpdatePunchAttack(int nCntEnemy);																		 // 敵の殴り攻撃の更新処理
...
bool isKickAttack(int nCntEnemy,Player* pPlayer);															 // キック攻撃ができるか
bool isPunchAttack(int nCntEnemy, Player* pPlayer);															 // パンチ攻撃できるか
void SetHitStopVibration(int nCntEnemy);																	 // ヒットストップしたときに震える処理
void LimitToMaxHP(int nCntEnemy);																			 // HPの制限処理
void UpdateEnemyState(int nCntEnemy);																		 // 敵の状態の遷移
void UpdatePositionEnemy(int nCntEnemy);																	 // 敵の位置の更新処理
void SetUpdateMotion(int nCntEnemy);																		 // モーションの更新処理の設定
